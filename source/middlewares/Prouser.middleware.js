...
const prouserauthverfication=Asynchandler(async (req,res,next)=>{
    try{
    ...
    const user = await Prouser.findById(decode._id).select("-password -RefreshToken")
...
export default prouserauthverfication; 